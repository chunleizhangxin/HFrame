package com.android.styy.common.widget.switchbutton;
...
public class SwitchButton extends CompoundButton {
    ...
    private int measureWidth(int widthMeasureSpec) {
        ...
        if (widthMode == MeasureSpec.EXACTLY) {
            ...
            /*
            If parent view want SwitchButton to determine it'PoiEntity size itself, we calculate the minimal
            size of it'PoiEntity content. Further more, we ignore the limitation of widthSize since we want
