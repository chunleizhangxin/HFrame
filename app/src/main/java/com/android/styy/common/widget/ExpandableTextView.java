...
public class ExpandableTextView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        id_source_textview = findViewWithTag(getContext().getString(R.string.tag_source_textview));
        id_expand_textview = findViewWithTag(getContext().getString(R.string.tag_expand_view));
