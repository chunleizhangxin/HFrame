...
//                .observeOn(Schedulers.io())
//                .flatMap(new Function<LocalMedia, Publisher<LocalMedia>>() {
//                    @Override
//                    public Publisher<LocalMedia> apply(final LocalMedia localMedia) throws Exception {
//                        return new Flowable<LocalMedia>() {
//                            @Override
//                            protected void subscribeActual(final Subscriber<? super LocalMedia> s) {
//
//                                File file = new File(localMedia.getPath());
//
//                                final File targetFile = new File(file.getParentFile().getAbsolutePath() + "/tmp",file.getName());
//
//                                VideoCompress.compressVideoLow(file.getPath(),targetFile.getPath() , new VideoCompress.CompressListener() {
//                                    @Override
//                                    public void onStart() {
//                                    }
//
...
//                                        localMedia.setCompressPath(targetFile.getPath());
//                                        s.onNext(localMedia);
//                                        s.onComplete();
//                                    }
//
...
//                        };
//                    }
//                }).subscribe(new Subscriber<LocalMedia>() {
//                    @Override
...
//                        Log.d("TAG","localMedia - " + localMedia);
//                    }
//
//                    @Override
