...
public class PullToRefreshWebView extends PullToRefreshBase<WebView> {
	...
	private final WebChromeClient defaultWebChromeClient = new WebChromeClient() {
		...
		public void onReceivedTitle(WebView view, String title) {
			...
			if (mPullToRefreshCallBack != null) {
				mPullToRefreshCallBack.updateWebTitle(title);
			}
		}
	...
	protected WebView createRefreshableView(Context context, AttributeSet attrs) {
		...
		View pulView = findViewById(R.id.pull_to_refresh_text);
		if (pulView != null && pulView instanceof TextView) {
			((TextView) pulView).setTextColor(Color.WHITE);
		}
		return webView;
	}
	...
	@TargetApi(9)
	final class InternalWebViewSDK9 extends EnhanceWebView {
	...
	public void setPullToRefreshCallBack(PullToRefreshCallBack callBack) {
		mPullToRefreshCallBack = callBack;
	}
